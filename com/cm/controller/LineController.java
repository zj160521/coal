...
public class LineController {
    ...
    public Object getAll(@RequestBody Line line, HttpServletRequest request){
        ...
        try{
            List<Sensor> sensorList = lineService.getAllSensorUid();
            HashMap<String, String> map = new HashMap<>();
            for (Sensor sensor : sensorList) {
                map.put(sensor.getUid(), sensor.getIpaddr() + ":" + sensor.getSensorId() + ":" + sensor.getSensor_type());
            }
            ...
            for (Line line1 : lines) {
                ...
                line1.setK(map.get(line1.getUid()));
            }
