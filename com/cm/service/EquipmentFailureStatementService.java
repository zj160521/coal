...
import com.cm.dao.EquipmentFailureStatementDao;
...
public class EquipmentFailureStatementService {
	...
	@Autowired
	private EquipmentFailureStatementDao dao;
	...
	public List<CommunicationVo> getallfail() throws ParseException{
		List<CommunicationVo> list = dao.getSensor(null);
		List<CommunicationVo> list2 = dao.getSwitchSensor(null);
		List<CommunicationVo> list3 = dao.getSubstation(null);
		List<CommunicationVo> list4 = dao.getEquipment(null);
		List<CommunicationVo> list5 = dao.getRadio(null);
