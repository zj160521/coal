...
public class CommunicationInterruptService {
	...
	public List<CommunicationVo> getbySensor(NameTime nameTime) throws ParseException{
		...
		List<CommunicationVo> list2 = dao.getbySwitch(nameTime);
		List<CommunicationVo> list3 = dao.getSubstation(nameTime);
		List<CommunicationVo> list4 = dao.getEquipment(nameTime);
