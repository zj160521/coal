...
public interface AnalogStatementDao {
	...
	public List<EnvClasses> getAlarmClass(NameTime nameTime);
	
	public List<EnvClasses> getSensorClass(NameTime nameTime);
	
	public List<EnvClasses> getStateClass(NameTime nameTime);
